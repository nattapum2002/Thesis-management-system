                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                            ...
                                            @else
                                                ...
                                                <td>
                                                    <button class="btn btn-orange"
                                                        wire:click="edit('time_submission')"><i
                                                            class='bx bx-edit'></i></button>
                                                </td>
                                            @endif
                                        </tr>
                                        <tr>
                                            ...
                                            @else
                                                <td>{{ thaidate('วันl ที่ j F พ.ศ.Y', $submission->date_submission) }}
                                                </td>
                                                <td>
                                                    <button class="btn btn-orange"
                                                        wire:click="edit('date_submission')"><i
                                                            class='bx bx-edit'></i></button>
                                                </td>
                                            @endif
                                        </tr>
                                        <tr>
                                            ...
                                            @if ($toggle['year_submission'])
                                                <td>
                                                    <div class="input-field">
                                                        <select class="form-select" wire:model='year_submission'
                                                            required>
                                            ...
                                            @else
                                                ...
                                                <td>
                                                    <button class="btn btn-orange"
                                                        wire:click="edit('year_submission')"><i
                                                            class='bx bx-edit'></i></button>
                                                </td>
                                            @endif
                                        </tr>
