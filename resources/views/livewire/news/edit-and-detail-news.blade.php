            ...
            <table class="table table-striped">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <div class="input-field">
                                <input class="form-input" wire:model="news_image" type="file" placeholder="เลือกไฟล์"
                                    required>
                                @error('news_image')
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="input-field">
                                <input class="form-input" wire:model="title" type="text" placeholder="หัวข้อ" required>
                                @error('title')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="input-field">
                                <textarea class="form-input" wire:model="details" type="text" placeholder="รายละเอียด"
                                    required></textarea>
                                @error('details')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
