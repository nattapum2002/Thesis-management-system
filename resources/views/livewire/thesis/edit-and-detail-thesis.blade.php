            ...
            <div class="card-body table-responsive p-0">
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <th>ชื่อบทความ</th>
                            <td colspan="2">{{ $thesis->title }}</td>
                        </tr>
                        <tr>
                            <th>รายละเอียด</th>
                            <td colspan="2">{{ $thesis->details }}</td>
                        </tr>
                        <tr>
                            <th>ปีการศึกษา</th>
                            <td colspan="2">{{ $thesis->year_published }}</td>
                        </tr>
                        <tr>
                            <th>ประเภทบทความ</th>
                            <td colspan="2">{{ $thesis->type }}</td>
                        </tr>
                        <tr>
                            <th>ไฟล์บทความ</th>
                            <td colspan="2">
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <div class="button-container">
                                    <button class="btn btn-success" wire:click="save('thesis_image')">บันทึก</button>
                                    <button class="btn btn-danger" wire:click="cancel('thesis_image')">ยกเลิก</button>
                                </div>
                            </td>
                            @else
                            <td>
                            ...
                            <td>
                                <div class="button-container">
                                    <button class="btn btn-primary" wire:click="edit('thesis_image')"><i
                                            class='bx bx-edit'></i></button>
                                </div>
                            </td>
                            @endif
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="button-container">
                                    <button class="btn btn-success" wire:click="save('year_published')">บันทึก</button>
                                    <button class="btn btn-danger" wire:click="cancel('year_published')">ยกเลิก</button>
                                </div>
                            </td>
                            @else
                            <td>{{ $thesis->year_published }}</td>
                            <td>
                                <button class="btn btn-primary" wire:click="edit('year_published')"><i
                                        class='bx bx-edit'></i></button>
                            </td>
                            @endif
                        </tr>
