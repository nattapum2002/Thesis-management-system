...
<div class="container-fluid">
    <ul class="navbar-nav">
        ...
        <li class="nav-item">
            <a href="/branch-head" class="nav-link">ระบบจัดการปริญญานิพนธ์</a>
        </li>
    </ul>
...
<a href="/branch-head" class="brand-link">
...
<div class="sidebar">
    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
            <a href="/branch-head/edit_branch_head" class="d-block">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="/branch-head/approve_documents_branch_head">
                            <i class='nav-icon bx bx-circle'></i>
                            อนุมัติเอกสาร
                        </a>
                    </li>
            ...
            <li class="nav-item">
                <a class="nav-link" href="/branch-head/edit_branch_head">
