...
<body>
    ...
    <div class="section">
        <table>
            ...
            @php
            $comment[$list] = $comments->where('id_teacher', $director->id_teacher)->where('id_document',
            $documentId)->where('id_position', 7)->where('id_comment_list', $list)->first();
            @endphp
            @endforeach
            @endforeach
            <tr>
                ...
                <td colspan="10">
                    <div>ครั้งที่<span class="dotted"> {{ count($examSchedules) }} </span>
                        เมื่อวันที่<span class="dotted"> {{ thaidate('j', $examSchedules->skip(1)->first()->exam_day) }}
                        </span>
                        เดือน<span class="dotted"> {{ thaidate('F', $examSchedules->skip(1)->first()->exam_day) }}
                        </span>
                        พ.ศ.<span class="dotted"> {{ thaidate('Y', $examSchedules->skip(1)->first()->exam_day) }}
                        </span>
                    </div>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td colspan="3">
                    <div>
                        <input type="checkbox" {{ isset($comment[3]) && $comment[3]->comment == 'ดี' ?
                        'checked' : '' }}>
                        <label>ดี </label>
                        <input type="checkbox" {{ isset($comment[3]) && $comment[3]->comment != 'ดี' ?
                        'checked' : '' }}>
            ...
            <tr>
                ...
                <td colspan="3">
                    <div>
                        <input type="checkbox" {{ isset($comment[4]) && $comment[4]->comment == 'ดี' ?
                        'checked' : '' }}>
                        <label>ดี </label>
                        <input type="checkbox" {{ isset($comment[4]) && $comment[4]->comment != 'ดี' ?
                        'checked' : '' }}>
            ...
            <tr>
                ...
                <td colspan="3">
                    <div>
                        <input type="checkbox" {{ isset($comment[5]) && $comment[5]->comment == 'เหมาะสมเพียงพอ' ?
                        'checked' : '' }}>
                ...
                <td colspan="3">
                    <div>
                        <input type="checkbox" {{ isset($comment[5]) && $comment[5]->comment == 'ไม่เพียงพอ' ?
                        'checked' : '' }}>
            ...
            <tr>
                ...
                <td colspan="3">
                    <div>
                        <input type="checkbox" {{ isset($comment[7]) && $comment[7]->comment == 'เหมาะสมเพียงพอ' ?
                        'checked' : '' }}>
                        <label>เหมาะสมเพียงพอ</label>
                    </div>
                </td>
                <td colspan="3">
                    <div>
                        <input type="checkbox" {{ isset($comment[7]) && $comment[7]->comment == 'ไม่เพียงพอ' ?
                        'checked' : '' }}>
                        <label>ไม่เพียงพอ</label>
                    </div>
                </td>
            ...
            <tr>
                ...
                <td colspan="3">
                    <div>
                        <input type="checkbox" {{ isset($comment[9]) && $comment[9]->comment == 'มาก' ?
                        'checked' : '' }}>
                        <label>มาก</label>
                    </div>
                </td>
                <td colspan="3">
                    <div>
                        <input type="checkbox" {{ isset($comment[9]) && $comment[9]->comment == 'ปานกลาง' ?
                        'checked' : '' }}>
                        <label>ปานกลาง</label>
                    </div>
                </td>
                <td colspan="3">
                    <div>
                        <input type="checkbox" {{ isset($comment[9]) && $comment[9]->comment == 'น้อย' ?
                        'checked' : '' }}>
                        <label>น้อย</label>
                    </div>
                </td>
            ...
            <tr>
                ...
                <td colspan="3">
                    <div>
                        <input type="checkbox" {{ isset($comment[11]) && $comment[11]->comment == 'ดี' ?
                        'checked' : '' }}>
                        <label>ดี </label>
                    </div>
                </td>
                <td colspan="3">
                    <div>
                        <input type="checkbox" {{ isset($comment[11]) && $comment[11]->comment == 'พอใช้' ?
                        'checked' : '' }}>
                        <label>พอใช้</label>
                    </div>
                </td>
            ...
            <tr>
                ...
                <td colspan="3">
                    <div>
                        <input type="checkbox" {{ isset($comment[13]) && $comment[13]->comment == 'มาก' ?
                        'checked' : '' }}>
                        <label>มาก</label>
                    </div>
                </td>
                <td colspan="3">
                    <div>
                        <input type="checkbox" {{ isset($comment[13]) && $comment[13]->comment == 'ปานกลาง' ?
                        'checked' : '' }}>
                        <label>ปานกลาง</label>
                    </div>
                </td>
                <td colspan="3">
                    <div>
                        <input type="checkbox" {{ isset($comment[13]) && $comment[13]->comment == 'น้อย' ?
                        'checked' : '' }}>
                        <label>น้อย</label>
                    </div>
                </td>
            ...
            <tr>
                ...
                <td colspan="3">
                    <div>
                        <input type="checkbox" {{ isset($comment[15]) && $comment[15]->comment == 'ไม่ซ้ำซ้อน' ?
                        'checked' : '' }}>
                ...
                <td colspan="3">
                    <div>
                        <input type="checkbox" {{ isset($comment[15]) && $comment[15]->comment == 'ซ้ำซ้อน' ?
                        'checked' : '' }}>
                        <label>ซ้ำซ้อน</label>
                    </div>
                </td>
            ...
            <tr>
                ...
                <td colspan="3">
                    <div>
                        <input type="checkbox" {{ isset($comment[17]) && $comment[17]->comment == 'เหมาะสม' ?
                        'checked' : '' }}>
                        <label>เหมาะสม</label>
                    </div>
                </td>
                <td colspan="3">
                    <div>
                        <input type="checkbox" {{ isset($comment[17]) && $comment[17]->comment == 'ไม่เหมาะสม' ?
                        'checked' : '' }}>
    ...
    <div class="section">
        <table>
            ...
            @foreach ($directors as $director)
            @php
            $result = $comments->where('id_teacher', $director->id_teacher)->where('id_document',
            $documentId)->where('id_position', 7)->where('id_comment_list', 1)->first();
            $resultDetail = $comments->where('id_teacher', $director->id_teacher)->where('id_document',
            $documentId)->where('id_position', 7)->where('id_comment_list', 2)->first();
            @endphp
            @endforeach
            <tr>
                <td style="width: 1.8em"></td>
                <td colspan="9">
                    <div>
                        <input type="checkbox" {{ isset($result) && $result->comment == 'อนุมัติ' ?
                        'checked' : '' }}>
                        <label> อนุมัติ</label>
                    </div>
                </td>
            ...
            <tr>
                ...
                <td colspan="9">
                    <div>
                        <input type="checkbox" {{ isset($result) && $result->comment == 'ให้แก้ไขปรับปรุงและอนุมัติได้'
                        ?
                        'checked' : '' }}>
            ...
            <tr>
                ...
                <td colspan="9">
                    <div>
                        <input type="checkbox" {{ isset($result) && $result->comment == 'ไม่อนุมัติ' ?
                        'checked' : '' }}>
            ...
            <tr>
                ...
                <td colspan="8">
                    <div>
                        ...
                        เมื่อวันที่<span class="dotted"> {{ thaidate('j', $examSchedules->first()->exam_day) }} </span>
                        เดือน<span class="dotted"> {{ thaidate('F', $examSchedules->first()->exam_day) }} </span>
            ...
            <tr>
                ...
                <td colspan="8">
                    <div>
                        @if ($confirm)
                        ลงชื่อ<span class="dotted"> {{ $director->teacher->name }} </span>{{ $director->id_position == 7
                        ? $director->position->position . ' (อาจารย์ที่ปรึกษา)' : $director->position->position }}
                        <br>(<span class="dotted">
                            {{ $director->teacher->prefix . ' ' . $director->teacher->name . ' ' .
    ...
    <div class="section">
        <table>
            ...
            $documentId)->where('id_position', 3)->where('id_comment_list', 1)->sortBy('created_at');
            $adminOtherComment = $comments->where('id_teacher', $admin->id_teacher)->where('id_document',
            $documentId)->where('id_position', 3)->where('id_comment_list', 2);
            $confirm = $projects->confirmTeachers
            ...
            <tr>
                ...
                <td>
                    <div>
                        <input type="checkbox" {{ $adminComments->where('comment',
                        'ให้แก้ไขตามที่เสนอแนะ')->isNotEmpty() ? 'checked' : '' }}>
            ...
            <tr>
                ...
                <td class="signature" colspan="4">
                    <div>
                        @if ($confirm)
                        ลงชื่อ<span class="dotted"> {{ $confirm->teacher->name }} </span>อาจารย์ผู้รับผิดชอบรายวิชา
                        <br>(<span class="dotted"> {{ $confirm->teacher->prefix . ' ' . $confirm->teacher->name . ' ' .
                            $confirm->teacher->surname }} </span>)
                        <br>วันที่<span class="dotted"> {{ $confirm->created_at->thaidate('j') }} </span>เดือน<span
                            class="dotted">
                            {{ $confirm->created_at->thaidate('F') }} </span>พ.ศ.<span class="dotted">
                            {{ $confirm->created_at->thaidate('Y') }} </span>
                        ...
                        <br>(<span class="dotted">
                            {{ $confirm->teacher->prefix . ' ' . $confirm->teacher->name . ' ' .
    ...
    <div class="section">
        <table>
            ...
            $documentId)->where('id_position', 4)->where('id_comment_list', 1)->sortBy('created_at');
            ...
            <tr>
                ...
                <td>
                    <div>
                        <input type="checkbox" {{ $branchHeadComments->where('comment',
                        'เห็นชอบ')->isNotEmpty() ? 'checked' : '' }}>
                        <label> เห็นชอบ</label>
                    </div>
                </td>
