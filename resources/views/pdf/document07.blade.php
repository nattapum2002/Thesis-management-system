...
<body>
    ...
    <div class="section">
        <table>
            ...
            @foreach ($projects->confirmTeachers->where('id_position', 1) as $confirm)
            <tr>
                <td style="width: 1.8em"></td>
                <td class="signature">
                    <div>
                        ลงชื่อ<span class="dotted"> {{ $confirm->teacher->name }} </span>{{ $confirm->id_position == 1 ?
    ...
    <div class="section">
        <table>
            ...
            <tr>
                ...
                <td class="signature">
                    <div>
                        ลงชื่อ<span class="dotted"> {{ $confirm->teacher->name }} </span>{{ $confirm->id_position == 5 ?
                        'ประธานกรรมการ' : ($confirm->id_position == 6 ? 'กรรมการ' : 'กรรมการและเลขานุการ') }}
                        <br>(<span class="dotted"> {{ $confirm->teacher->prefix . ' ' . $confirm->teacher->name.'
                            '.$confirm->teacher->surname }}
                        </span>)
                        <br>วันที่<span class="dotted"> {{ thaidate('j', $confirm->created_at) }} </span>
    ...
    <div class="section">
        <table>
            ...
            <tr>
                ...
                <td colspan="2">
                    <div>
                        <input type="checkbox" {{ $adminComments->first()->comment == 'อนุมัติ' ? 'checked' : '' }}>
                        <label> อนุมัติ</label>
                    </div>
                </td>
                <td>
                    <div>
                        <input type="checkbox" {{ $adminComments->first()->comment == 'ให้ปรับปรุงแก้ไขอีกครั้ง' ?
                        'checked' : '' }}>
    ...
    <div class="section">
        <table>
            ...
            <tr>
                ...
                <td>
                    <div>
                        <input type="checkbox" {{ $branchHeadComments->first() == 'ให้ปรับปรุงแก้ไขอีกครั้ง' ? 'checked'
                        : '' }}>
                        <label> ให้ปรับปรุงแก้ไขอีกครั้ง</label>
                    </div>
                </td>
