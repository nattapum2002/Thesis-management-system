...
class AddTeacher extends Component
{
    ...
    protected function rules()
    {
        return [
            ...
            'add_name' => 'required|string|max:255|regex:/^[^\d]*$/',
            'add_surname' => 'required|string|max:255|regex:/^[^\d]*$/',
    ...
    protected function messages()
    {
        return [
            ...
            'add_name.string' => 'กรุณากรอกชื่อให้ถูกต้อง',
            'add_name.max' => 'ชื่อต้องไม่เกิน 255 ตัวอักษร',
            'add_name.regex' => 'ชื่อต้องไม่มีอักขระพิเศษ',
            'add_surname.required' => 'กรุณากรอกนามสกุล',
            'add_surname.string' => 'กรุณากรอกนามสกุลให้ถูกต้อง',
            'add_surname.max' => 'นามสกุลต้องไม่เกิน 255 ตัวอักษร',
            'add_surname.regex' => 'นามสกุลต้องไม่มีอักขระพิเศษ',
