...
Route::get('/send-line-messages', [LineController::class, 'sendLineMessages']);
...
//Admin Route
Route::middleware(['check_user_type:Admin', 'teacher_login'])->group(function () {
...
// branch-head Routes
Route::middleware(['check_user_type:Branch head', 'teacher_login'])->group(function () {
...
// Teacher Routes
Route::middleware(['check_user_type:Teacher', 'teacher_login'])->group(function () {
...
// Member Routes
Route::middleware(['member_login'])->group(function () {
